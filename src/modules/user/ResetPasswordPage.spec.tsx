...
describe.skip("<ResetPasswordPage />", () => {
  ...
  it("shows an error if the current password is blank", async () => {
    await act(async () => {
      findByTestId(wrapper, "reset-password-button")
        .hostNodes()
        .simulate("click");
      ...
      expect(
        wrapper.containsMatchingElement(
          <p>Current password can&#39;t be blank.</p>,
        ),
      ).toBe(true);
    });
  });
  ...
  it("shows an error if the new password is blank", async () => {
    await act(async () => {
      ...
      expect(
        wrapper.containsMatchingElement(
          <p>New password can&#39;t be blank.</p>,
        ),
      ).toBe(true);
    });
  });
  ...
  it("shows an error if the password confirm is blank", async () => {
    await act(async () => {
      ...
      expect(
        wrapper.containsMatchingElement(
          <p>Password confirmation can&#39;t be blank.</p>,
        ),
      ).toBe(true);
    });
  });
  ...
  it("shows an error if the new passwords dont match", async () => {
    await act(async () => {
      ...
      expect(
        wrapper.containsMatchingElement(<p>Password don&#39;t match.</p>),
      ).toBe(true);
    });
  });
  ...
  it("shows an error if the password length is too short", async () => {
    await act(async () => {
      ...
      const expectedElement = (
        <p>Password needs to have a minimum of 8 characters.</p>
      );
