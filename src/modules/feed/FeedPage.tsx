...
import {Divider, Grid, GridColumn, Icon, Rail, Responsive, Segment,} from "semantic-ui-react";
import {PullToRefresh} from "../../components";
import settings from "../../config/settings";
import {Navigation} from "../../components/navigation";
import {CreatePost, GoalProgress, LeftRail, RightRail, Transaction, TransactionLoading,} from "./components";
...
const RepoList: React.FC<Props> = ({data: {loading, error, teamById, loadMore}}) => {
