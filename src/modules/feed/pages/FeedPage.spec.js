...
const transactionList = [
    ...
    receivers: [
      {
        ...
        description:
          "You can't back up the hard drive without backing up the optical SDD alarm!",
        location: "Alabama"
      }
    ],
    message:
      "You can't generate the pixel without backing up the solid state JBOD circuit!",
    kudos: 9,
    comments: 22,
    likes: 18,
  ...
  },
  {
    ...
    message:
      "You can't parse the interface without compressing the mobile HTTP application!",
    kudos: 35,
    comments: 39,
    likes: 22,
