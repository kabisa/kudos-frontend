...
const loginSuccess = state =>
  updateObject(state, { loginLoading: false, loginError: null, loginSuccess: true });
 ...
 *  Reset password
 */
const resetPasswordBegin = state => updateObject(state, { resetPasswordLoading: true });
const resetPasswordSuccess = state => updateObject(state, { resetPasswordLoading: false });
const resetPasswordFailure = (state, action) =>
  updateObject(state, { resetPasswordLoading: false, resetPasswordError: action.payload });
