...
const getUserInfoBegin = state => updateObject(state, { getUserInfoLoading: true });
const getUserInfoSuccess = (state, action) =>
  updateObject(state, { getUserInfoLoading: false, getUserInfoError: null, data: action.payload });
const getUserInfoFailure = (state, action) =>
  updateObject(state, { getUserInfoLoading: false, getUserInfoError: action.payload });
