  ...
  module Actions
    ...
    class ZipalignAction < Action
      def self.run(params)
       ...
       zipalign = Fastlane::Actions.sh("zipalign -c -v 4 #{params[:apk_path]}", log: true , error_callback: error_callback)
